...
#
# Adapted by jan.winkler@tu-dresden.de for usage with WinPython: mkl libs
# are located in directory DLLs of the numpy package. 'DLLs' added to
# extra_dll_locations
# -----------------------------------------------------------------------------
import os
import glob
...
# for example)
if is_win:
    extra_dll_locations = ['extra-dll', '.libs', 'DLLs']
