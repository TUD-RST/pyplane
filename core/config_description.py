{
    ...
    "nc_color_xdot": ["Color x-nullcline", "magenta"],
    "nc_color_ydot": ["Color y-nullcline", "red"],
    ...
    "traj_ppForwardColor": ["Color of forward trajectories", "#000000"],
    "traj_ppBackwardColor": ["Color of backward trajectories", "#000000"],
    "traj_x_tColor": ["Color of x(t) curves", "#000000"],
    "traj_y_tColor": ["Color of y(t) curves", "#000000"],
    "traj_plotInitPoint": ["Mark initial condition", True],
    "traj_initPointColor": ["Color of initial condition", "#d1193b"],
